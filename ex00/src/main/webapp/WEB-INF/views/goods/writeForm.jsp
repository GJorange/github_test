	...
	<div class="container">
	  ...
	  <form action="write.do" method="post" enctype="multipart/form-data">
    	<input type="hidden" name="perPageNum" value="${param.perPageNum}" />
	      <label for="name" style="">제품 등록</label>
		    ...
		    <div class="form-group" style="margin-top: 60px;">
		      <textarea class="form-control ipt" rows="7" id="content" name="content" placeholder="제품설명" required></textarea>
		    </div>
		    <div class="form-group">
				<!-- 파일로 넘어가는 데이터는 GoodsVO 객체의 이름과 다른이름을 사용해야 합니다. -->
				<label for="imageMain">대표이미지</label>
				<input type="file" class="form-control ipt" id="imageMain" name="imageMain" required>	
			</div>
		    <div class="form-group">
		      <input type="text" class="form-control ipt" id="goodsPrice" pattern="^[A-Z0-9].{3.20}$" required
		      		title="대문자와 숫자만 입력 3~20자 입력" placeholder="정가" name="price" style="float: left;">
		      <input type="text" class="form-control ipt" id="goodsPrice2" pattern="^[A-Z0-9].{3.20}$" required
		    ...
		    <fieldset class="border p-4 imageForm" style="width: 100%; border-radius: .25rem;">
			    ...
			    <div class="input-group mb-3">
			        <input type="file" class="form-control ipt" name="imageFiles" multiple>
			    </div>
			</fieldset>
