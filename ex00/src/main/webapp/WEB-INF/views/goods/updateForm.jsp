	  ...
	  <input type="hidden" name="goods_price_no" value="${goodsVO.goods_price_no }">
	      ...
	      <label for="name" style="color: #999;">제품정보 수정</label>
		    <div class="form-group">
		      ...
		      <label for="name" style="margin: 16px 0 -4px 0; color: #999;">카테고리</label>
		    <div class="form-group">
		      <select class="form-control ipt" name="cate_code1" style="float: left; width: 49%; height: 35px; padding-left: 10px; color: black;">
